...
public class Test {
	...
	private static void testRMI() throws XmlRpcException, IOException {
		new Windrad();
		new Windrad();
		new Windrad();
		
		Zentralrechner zen = new Zentralrechner();
		zen.setRun(false);
		zen.controlWindrad();
	}
	
	private static void testRPCMOM() throws XmlRpcException, IOException {
